...
// react ui
import {Textarea, Input, Table, TableHeader, TableColumn, TableBody, TableRow, TableCell, Select, SelectItem, Image} from "@nextui-org/react";
...
const TransferFunds = () => {
  const {currentAccount, transferEther, accountBalance, loading, transaction, transactionCount, getAllTransactions} = useContext(NFTMarketplaceContext)
      ...
      <div className='my-auto'>
        <div className='flex justify-around sm:flex-col md:flex-row max-sm:flex-col max-sm:gap-5'>
          <div className='w-1/3 md:w-[40%] sm:w-[90%] max-sm:w-[90%] mx-auto h-max shadow-md p-2 border rounded-xl'>
            ...
            <form>
                  <label className='text-1xl mb-2' htmlFor='Ether'>Receive Address</label>
                  <Input
                    type="text"
                    placeholder="0x..."
                  ...
                  />
                  <label className='text-1xl mb-2' htmlFor='Ether'>Your Price</label>
                 <Input
                    placeholder="0.00"
                    labelPlacement="outside"
                    min={0.05}
          ...
          <div className='w-[60%] md:w-[50%] sm:w-[90%] max-sm:w-[90%] flex flex-col gap-5 mx-auto'>
              <div className='flex xl:flex-row md:flex-col max-sm:flex-col justify-between gap-5 border rounded-xl p-5 shadow-md'>
                ...
                <div>
                  ...
                  <p className='flex item-center text-black-600 text-sm'><FaEthereum/> {accountBalance.slice(0,7)} ETH</p>
                </div>
                <div>
                  <p className='text-gray-400 font-thin text-sm'>ETH VALUE</p>
                  <p className='flex item-center text-black-600 text-sm'>0.0$</p>
                </div>
                <div>
                  <div>
                  <p className='text-gray-400 font-thin text-sm'>TOKEN HOLDINGS</p>
              ...
              <div className='flex justify-between gap-5 border rounded-xl p-5 shadow-md'>
                <div className='flex xl:flex-row md:flex-col max-sm:flex-col '>
                  ...
                  <div>
                    <p className='text-black-400 bg-transfer-500 font-thin text-sm'>$0 (Multichain Portfolio)</p>
                  </div>
                  <div>
                    <p className='text-gray-400 font-thin text-sm'>ETH VALUE</p>
                    <p className='flex item-center text-black-600 text-sm'>0.0$</p>
                  ...
                  <div className='min-w-[300px] flex flex-col gap-5'>
                    <h3 className='text-gray-700 font-medium font-semibold'>TRANSACTIONS</h3>
                    <div className='flex justify-between'>
                      <div className='flex gap-2'>
                        ...
                        <div>
                          <p className='text-gray-400 font-thin text-sm'>TRANSACTIONS</p>
                          <p className='flex item-center text-black-600 text-sm'>2,402.52 M (15.4 TPS)</p>
                        </div>
                      </div>
                      <div>
                        <p className='text-gray-400 font-thin text-sm'>MED GAS PRICE</p>
                        <p className='flex item-center text-black-600 text-sm'>18 Gwei ($1.34)</p>
                      </div>
                    </div>
                    <div className='flex justify-between gap-10'>
                      <div className='flex gap-1'>
                        ...
                        <div>
                          <p className='text-gray-400 font-thin text-sm'>LAST FINALIZED BLOCK</p>
                          <p className='flex item-center text-black-600 text-sm'>20075419</p>
                        </div>
                      </div>
                      <div>
                        <p className='text-gray-400 font-thin text-sm'>LAST SAFE BLOCK</p>
                        <p className='flex item-center text-black-600 text-sm'>20075419</p>
                      </div>
                    </div>
                  </div>
         ...
         {/* // history */}
            <h2 className='text-2xl font-semibold ml-14 my-5'>History your transfer</h2>
